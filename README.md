...
### Example of what the device could look like in production with further development
...
From the kit, I used the following components:
...
**Imported libraries in the main.py file:**
...
### Script running on the Termux app in the mobile phone to send data to Adafruit
...
![image](https://github.com/user-attachments/assets/ece066cc-ccea-429c-8e49-f7905ac64ba9)
